...
@Entity
@Audited
@Table(name = "TRA_USUA_EXT_X_PERFILES", uniqueConstraints = @UniqueConstraint(columnNames = { "USUA_X_USUA", "PERF_X_PERF" }))
public class UsuarioExternoPerfil implements java.io.Serializable {
	...
	public UsuarioExternoPerfil() {
	}

	@Id
	@SequenceGenerator(allocationSize = 1, name = "generator", sequenceName = "TRA_S_USEXTPE_X_USEXTPE")
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UsuarioExternoPerfil))
			return false;
		UsuarioExternoPerfil castOther = (UsuarioExternoPerfil) other;
