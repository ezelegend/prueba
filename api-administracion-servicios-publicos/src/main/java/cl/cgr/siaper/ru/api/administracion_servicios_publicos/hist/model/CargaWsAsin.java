...
@Entity
@Audited
@AuditTable("TRA_CARGA_WS_ASIN_HIST")
@Table(name = "TRA_CARGA_WS_ASIN")
public class CargaWsAsin implements java.io.Serializable{
	...
	private Long numeroHechos;
	
	@Id
	@SequenceGenerator(allocationSize = 1, name = "generator", sequenceName = "TRA_S_CAAS_X_CAAS")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator")
	@Column(name = "X_CAAS", unique = true, nullable = false, precision = 10, scale = 0)
	public Long getId() {
		return id;
	}
	 ...
	 */
	@Column(name = "N_HECHOS")
	public Long getNumeroHechos() {
		return numeroHechos;
	}
	 ...
	 */
	public void setNumeroHechos(Long numeroHechos) {
		this.numeroHechos = numeroHechos;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CargaWsAsin))
			return false;
		CargaWsAsin castOther = (CargaWsAsin) other;
