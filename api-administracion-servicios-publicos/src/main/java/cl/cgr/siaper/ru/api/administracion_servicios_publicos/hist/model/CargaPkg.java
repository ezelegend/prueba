...
@Entity
@Audited
@AuditTable("TRA_CARGA_PKG_HIST")
@Table(name = "TRA_CARGA_PKG")
public class CargaPkg implements java.io.Serializable{
	...
	@Id
	@SequenceGenerator(allocationSize = 1, name = "generator", sequenceName = "TRA_S_CAPK_X_CAPK")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator")
	@Column(name = "X_CAPK", unique = true, nullable = false, precision = 10, scale = 0)
	public Long getId() {
		return id;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CargaPkg))
			return false;
		CargaPkg castOther = (CargaPkg) other;
