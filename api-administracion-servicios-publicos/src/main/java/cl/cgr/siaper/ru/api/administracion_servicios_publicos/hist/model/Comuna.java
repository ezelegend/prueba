...
public class Comuna implements java.io.Serializable, Comparable<Comuna> {
	...
	@Id
	@SequenceGenerator(allocationSize = 1, name = "generator", sequenceName = "TRA_S_COMU_X_COMU")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator")
	@Column(name = "X_COMU", unique = true, nullable = false, precision = 10, scale = 0)
	public Long getId() {
		return this.id;
	}
	...
	@JoinColumn(name = "REGI_X_REGI", nullable = false)
	...
	@Column(name = "S_COMU", nullable = false, precision = 12, scale = 0)
	...
	@Column(name = "D_COMU", nullable = false)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Comuna))
			return false;
		Comuna castOther = (Comuna) other;
		return this.getId() != null && castOther.getId() != null && this.getId().equals(castOther.getId());
	}

	public int compareTo(Comuna com) {
		return this.getDescripcion().compareTo(com.getDescripcion());
	}
